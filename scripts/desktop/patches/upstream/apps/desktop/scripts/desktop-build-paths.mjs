 ...
 * @returns {{ root: string, artifacts: string, runtime: string, packageSet: string, seed: string, seedPnpm: string, nodeExtract: string, packedDsh: string, packedVendor: string, packedLandlock: string, packedWorkdsh: string, downloads: string }} Target paths plus the shared immutable download cache.
 */
